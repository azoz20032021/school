...
var homeworkRef = collection(db, "homework");
...
var lastSweep = 0;
var sweepInFlight = null;
function maybeSendDueReminders() {
  const now = Date.now();
  if (sweepInFlight || now - lastSweep < SWEEP_INTERVAL_MS) return;
  lastSweep = now;
  sweepInFlight = sendDueReminders().then(() => void 0).catch((err) => console.error("[dues] reminder sweep failed:", err?.message || err)).finally(() => {
    sweepInFlight = null;
  });
}
  ...
  for (const d of snapshot.docs) {
    ...
    if (left < 0) {
      ...
      pending.push({
        ...
        message: `\u0627\u0646\u062A\u0647\u0649 \u0645\u0648\u0639\u062F \u062A\u0633\u062F\u064A\u062F "${inv.title}" \u0628\u062A\u0627\u0631\u064A\u062E ${inv.due_date} \u0648\u0627\u0644\u0645\u0628\u0644\u063A \u0627\u0644\u0645\u062A\u0628\u0642\u064A ${money(remaining)}. \u064A\u0631\u062C\u0649 \u0645\u0631\u0627\u062C\u0639\u0629 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u062F\u0631\u0633\u0629 \u0644\u0644\u062A\u0633\u062F\u064A\u062F.`
      });
      continue;
    }
...
// backend/routes/homework.routes.ts
...
router11.post(
  ...
  wrap(async (req, res) => {
    const classId = str(req.body?.class_id, "\u0627\u0644\u0635\u0641", { max: 64 });
    const subject = str(req.body?.subject, "\u0627\u0644\u0645\u0627\u062F\u0629", { min: 2, max: 80 });
    const title = str(req.body?.title, "\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0648\u0627\u062C\u0628", { min: 2, max: 120 });
...
var homework_routes_default = router11;
...
app.post(
  ...
  async (req, res, next) => {
    try {
      ...
      const created = await addDoc10(usersRef, {
        name,
        username: uid,
        uid,
...
app.use("/api", homework_routes_default);
